...
urlpatterns = [
    ...
    path('account/create/', orders_app.views.sign_up_view, name='signup'),
    path('get_name/', orders_app.views.get_name, name='get_name'),
    path('your-name/', orders_app.views.your_name, name='your-name')
